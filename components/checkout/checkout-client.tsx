...
export function CheckoutClient({ user }: { user: { name: string; email: string } }) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      <h1 className="mb-2 font-display text-3xl font-black tracking-tight sm:text-4xl">
        Checkout
      </h1>
...
<div className="grid gap-4 sm:grid-cols-2">
            <Input label="Full Name" name="customerName" defaultValue={user.name} error={field("customerName")} />
            <Input
              label="Phone"
              name="customerPhone"
              type="tel"
